...
export default function Home() {
  ...
  return (
    <>
      ...
      <RootLayout>
        {/* Hero Section */}
        <motion.div variants={zoomIn} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Hero
        ...
        {/* Page End Hero */}
        <motion.div variants={zoomIn} initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-7xl py-12 mx-auto">
          <PageEndHero
