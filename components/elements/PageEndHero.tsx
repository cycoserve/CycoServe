...
const PageEndHero: React.FC<PageEndHeroProps> = ({
  ...
  return (
    <>
    <section
      className="hero-section bg-gradient-to-tr from-black to-zinc-900  min-h-[100vh] my-8 flex md:h-fu lg:h-1/2 justify-center items-center relative text-white bg-cover bg-top bg-no-repeat rounded-lg border border-zinc-800"
    >
