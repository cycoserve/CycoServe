  ...
  return (
    <SectionWrap>
      <div className="max-w-4xl mx-auto">
        <ParagraphTitle>CycoServe FAQ</ParagraphTitle>
        ...
        {showContactForm && (
          <div className="mt-8 bg-white shadow-md p-6 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded-full transition duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-500"
              >
                Submit Question
              </button>
            </form>
