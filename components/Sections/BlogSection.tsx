  ...
  return (
    <>
      <div className="px-4 lg:px-0">
        <section className="container py-4 mx-auto px-4 lg:px-4 bg-zinc-950 backdrop-blur-sm rounded-md border-gray-500 border-2 border-opacity-15 my-12">
